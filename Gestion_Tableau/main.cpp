...
//TODO:Revoir la fonction rand() pour que les nombre al�atoire soit choisie correctement sans que forc�ment il
//Enlever l'initailisation du tableau du switch
//Trouver une autre mani�re de g�rer la fonction deleteFirst et LastOcurrence pour ne pas avoir � allouer dynamiquement de la m�moire
...
//Fonction permettant d'afficher le menu des diff�rentes fonctions du programme
void displayMenu()
{
    string menu = "\n\n** 0 ** Quitter le programme\n** 1 ** Affichage tableau al�atoire\n** 2 ** Tri tableau\n** 3 ** Suppression 1er occurence\n** 4 ** Suppression derni�re occurence\n** 5 ** Supression de toute les occurences";
    cout << "****MENU****" << endl;
    cout << menu << endl;
}

//Fonction permettant d'initialiser le tableau avec des valeur al�atoire.
...
//Fonction permettant de supprimer la premi�re occurence choisie.
...
//Fonction permettant de supprimer la derni�re occurence choisie.
